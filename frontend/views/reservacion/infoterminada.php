    ...
    <?php if ($serv[$i]->estado == 2) { ?>
                        ...
                        echo $fe[2] . "-" . $fe[1] . "-" . $fe[0]
                            ...
                            <th class="text-center">
                                <a href="<?= \Yii::$app->urlManager->createUrl(['reservacion/delete_servterminada', 'id' => $serv[$i]->id, 'res' => $id_res]); ?>" data-confirm="Estas seguro que deseas eliminar el servicio"><i class="fa fa-remove" data-toggle="tooltip" data-placement="top" title="Eliminar"></i></a>      
...
?>
            ...
            <div class="col-md-1" style="margin-top: 1.8em">
                <p><a href="<?= \Yii::$app->urlManager->createUrl(['reservacion/terminada', 'id' => $id_res]); ?>" class="btn btn-danger">Terminar</a></p>
