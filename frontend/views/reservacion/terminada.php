            ...
            <div class="panel-body">
                            ...
                            <div id="respond">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="margin-top: 0.8em">
                                        <a href="<?= \Yii::$app->urlManager->createUrl(['reservacion/index', 'tab' => 4]); ?>" class="btn btn-danger text-center" style="height: 35px;width: 60%"><i class="fa fa-arrow-circle-left">  </i><b> TERMINAR</b></a>
                ...
                <div class="col-md-6">
                    ...
                    <div class="panel panel-default" id="">
                        ...
                        <div class="panel-body" style="width: 100%;height: 625px;overflow-y: scroll;overflow-x:hidden;">
...
<!--                                <table class="head">
                                ...
                                <div class="inner_table">
                                    <table  class="table table-striped table-bordered " id="serv">
...
//                            );
                                            ...
                                            $result[count($result)] = array(
                                                'desc' => '',
                                                'cant' => '',
                                                'precio' => '<h4 style="margin-left:1em">' . 'TOTAL' . '</h4>',
                            ...
                            <div class="row" style="margin-top: 2em">
                                ...
                                <div class="col-md-2  text-left" >
                                    <p><a href="<?= \Yii::$app->urlManager->createUrl(['reservacion/inforesterminada', 'id' => $model->id]); ?>" class="btn btn-primary">INFO</a></p>
                                </div>
                ...
                <div class="col-md-4">
                    <div id="imp_espanol" class="Imprime" style="width: 230px;" >
                        ...
                        <table border="0" width="230" >
                            <thead >
                                <tr>
                                    <th width="140px" style="text-align: justify;text-decoration: underline;">SERVICIO</th>
                                    ...
                                    <th width="30px" style="text-decoration: underline;">IMPORTE</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                if (count($mos_res) != 0) {
                                    ...
                                    if ($hab == "") {
                                        ...
                                        <tr>
                                            ...
                                            'cant' => '<p style="margin-left:2em">' . $dif_dias . '</p>',
                                            'precio' => '<p style="margin-left:1em">' . $mos_res[0]['precio'] . '</p>',
                                            'total' => '<p style="margin-left:1em">' . $mo . '</p>'
                                        );
                                        $imp+=$mos_res[0]['precio'] * $dif_dias;
                                    }
                                }
                ...
                <div class="col-md-4">
                    <div id="imp_ingles" class="Imprime" style="width: 230px;">
                        ...
                        <table border="0">
                            <thead >
                                <tr>
                                    <th width="140px" style="text-align: justify;text-decoration: underline;">SERVICE</th>
                                    ...
                                    <th width="30px" style="text-decoration: underline;">AMOUNT</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                        ...
                        <div id="<?= $mos_hab1[$i]['id'] . '_espanol' ?>" class="Imprime" style="width: 230px;">
                            ...
                            <table border='0'>
                                ...
                                if (count($mos_res) != 0) {
                                    ...
                                    <tr>
                                        <th width="120px" style="width: 120;text-align: justify;"><table  style="width: 120px">
                                        <tr>
                                            <td style="width: 1px">
                                    ...
                                    <tr>                                        
                                        <th ><table  style="width: 120">
                                        <tr>
                                            <td style="width: 10">

                                            </td>
                                            <td style="width: 110;text-align: justify">
                                                <p style="text-align: justify"> HAB <?php echo $mos_res1[$i]['nombre'] ?> </p>
                                            </td>
                                        </tr>
                                    </table></th>
                                    <th><p style="margin-left:1em"><?php echo $dif_dias ?></p></th>
                                    <th><p style="margin-left:1em"><?php echo $mos_res1[$i]['precio'] ?></p></th>
                                ...
                                for ($k = 0; $k < count($servicios); $k++) {
                                    ?>
                                    <tr>
                                        <th><table  style="width: 120px">
                                        <tr>
                                            <td style="width: 1px">

                                            </td>
                                            <td style="width: 119px">
                                                <b style="text-align: justify"><?php echo $servicios[$k]['nombre'] ?></b>
                                            </td>
                                        </tr>
                                    </table></th>
                                    <th></th>
                                    ...
                                    for ($m = 0; $m < count($subservicios); $m++) {
                                        ...
                                        <th><p style="margin-left:2em"><?php echo $subservicios[$m]['cant'] ?></p></th>
                                        <th><p style="margin-left:1em"><?php echo $subservicios[$m]['precio'] ?></p></th>
