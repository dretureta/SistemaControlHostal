...
for ($i = 0; $i < count($mos_res); $i++) {
    $habitaciones.="" . $mos_res[$i]->hab0->nombre . " ";
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row" style="padding-top: 15px; font-size: 12px; line-height: 25px; color: #3b569d;">
                            <div class="col-md-6" style="border-left: 1px dotted #337AB7;">
                                <i class="fa fa-bed"></i> <span class=""><b>HABITACION(ES): <?php echo $habitaciones ?></b></span><br>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <select id="id_serv" class="form-control">
                                                    ...
                                                    <?php
                                                    $servicio = Servicio::find()->where([ 'estado' => 0])->orderBy("prioridad asc")->all();
...
//print_r(count($mos_hab));die;
                ...
                <div class="col-md-4">
                    <div id="imp_espanol" class="Imprime" style="width: 210px;" >
                        -----------------------------------------------------------------------------
...
//                            );
                        ...
                        <p style="margin-left:5em"><b style=" margin-left:2em">"THANKS FOR VISITING US"</b></p>
                    </div>
                </div>
