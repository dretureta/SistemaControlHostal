...
<!--                        <li class="">
        ...
        $sum_utilidad = ReservacionServicios::find()->where(['like', 'fecha', $fecha])->andWhere(['!=', 'estado', 2])->all();

//print_r(count($sum_utilidad));die;
        ...
        $command = $connection->createCommand("SELECT reservacion_hab.fecha_entrada,reservacion_hab.fecha_salida,reservacion_hab.precio from reservacion,reservacion_hab where reservacion.id=reservacion_hab.reservacion   and reservacion.fecha_entrada >=:fecha_ent and reservacion.fecha_entrada <=:fecha_sal");
